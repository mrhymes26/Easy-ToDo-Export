...
public class AuthService
{
    ...
    // Enterprise-Version: Unterstützt Organisations-Konten (Work/School Accounts)
    ...
    private const string CacheFileName = "todo_export_enterprise_cache.bin";
    private static readonly string CacheDir = Path.Combine(
        Environment.GetFolderPath(Environment.SpecialFolder.LocalApplicationData),
        "TodoExportEnterprise");
    ...
    private async Task InitializeAsync()
    {
        ...
        try
        {
            ...
            var storageProperties = new StorageCreationPropertiesBuilder(CacheFileName, CacheDir)
                .WithLinuxKeyring(
                    schemaName: "com.todoexport.enterprise.tokencache",
                    collection: "default",
                    secretLabel: "TodoExport Enterprise Token Cache",
                    attribute1: new KeyValuePair<string, string>("Version", "1"),
                    attribute2: new KeyValuePair<string, string>("App", "TodoExportEnterprise"))
                .WithMacKeyChain(
                    serviceName: "TodoExportEnterprise",
